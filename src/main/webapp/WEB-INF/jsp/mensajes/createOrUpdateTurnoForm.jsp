...
<idus_martii:layout pageName="mensajes">
    ...
    <jsp:body>
        <h2>
            <c:if test="${turno['new']}">Nuevo </c:if> turno
        </h2>
        <form:form modelAttribute="turno"
            ...
            <div class="form-group has-feedback">                
                ...
                <idus_martii:inputField label="Id de ronda" name="ronda"/>
            </div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <c:choose>
                        <c:when test="${turno['new']}">
                            <button class="btn btn-default" type="submit">Añadir turno</button>
                        </c:when>
                        <c:otherwise>
                            <button class="btn btn-default" type="submit">Actualizar turno</button>
                        </c:otherwise>
                    </c:choose>
                </div>
            </div>
